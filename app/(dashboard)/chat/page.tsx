  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "1",
      role: "atlas",
      content: "Hello! I am Atlas, your AI Chief of Staff. How can I help you today?",
      timestamp: new Date(),
    },
  ])
  ...
  const handleSend = async () => {
    ...
    setTimeout(() => {
      const atlasMessage: Message = {
        ...
        role: "atlas",
        content: "I understand. Let me help you with that request. Is there anything specific you would like me to focus on?",
        timestamp: new Date(),
      }
    ...
    <div className="h-screen flex flex-col">
      ...
      <div className="p-6 border-t border-gray-800">
        <div className="flex gap-4">
          ...
          <input type="text" value={input} onChange={(e) => setInput(e.target.value)} onKeyDown={handleKeyDown} placeholder="Ask Atlas anything..." className="flex-1 bg-gray-800 border border-gray-700 rounded-xl px-4 py-3 text-white placeholder:text-gray-500 focus:outline-none focus:border-blue-500 transition" />
