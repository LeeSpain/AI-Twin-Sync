...
via-gray-900 to-gray-950 flex items-center justify-center px-4">
...
from-blue-500 to-purple-600 flex items-center justify-center">
            ...
            <span className="text-2xl font-bold text-white">AI Twin 
Sync</span>
          </Link>
          <p className="text-gray-400 mt-2">Create your account to get 
started.</p>
        </div>
...
rounded-lg pl-10 pr-4 py-3 text-white placeholder:text-gray-500 
...
w-5 h-5 text-gray-500" />
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full bg-gray-900 border border-gray-700 
rounded-lg pl-10 pr-12 py-3 text-white placeholder:text-gray-500 
focus:outline-none focus:border-blue-500 transition"
                  required
                  minLength={8}
                />
...
className="w-5 h-5" />}
              ...
              <p className="text-gray-500 text-xs mt-1">Minimum 8 
characters</p>
            </div>
...
to-purple-600 text-white py-3 rounded-lg font-medium hover:opacity-90 
