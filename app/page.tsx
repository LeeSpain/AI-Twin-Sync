...
export default function LandingPage() {
  const features = [
    ...
    { icon: Mic, title: "Voice Commands", desc: "Hey Atlas, what is my day look like?" },
      ...
      <header className="fixed top-0 w-full z-50 bg-gray-900/80 backdrop-blur-md border-b border-gray-800">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/signup" className="bg-gradient-to-r from-blue-500 to-purple-600 text-white px-4 py-2 rounded-lg hover:opacity-90 transition">
              Get Started
            </Link>
          </div>
        </div>
      ...
      <section className="pt-32 pb-20 px-4">
        <div className="container mx-auto text-center max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
            ...
            <Link href="#demo" className="bg-gray-800 text-white px-8 py-4 rounded-lg text-lg font-medium hover:bg-gray-700 transition">
              Watch Demo
            </Link>
          </div>
      ...
      <section id="features" className="py-20 px-4 bg-gray-900/50">
        <div className="container mx-auto max-w-6xl">
          ...
          <p className="text-gray-400 text-center mb-12 max-w-2xl mx-auto">
            Atlas handles your busywork so you can focus on what actually matters.
          </p>
      ...
      <section id="pricing" className="py-20 px-4">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700 rounded-2xl p-8 max-w-md mx-auto">
            ...
            <p className="text-gray-500 text-sm text-center mt-4">14-day free trial. No credit card required.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-blue-600/20 to-purple-600/20">
        <div className="container mx-auto text-center max-w-2xl">
          ...
          <p className="text-gray-400 mb-8">
            Join hundreds of executives who have reclaimed their focus with Atlas.
          </p>
          <Link href="/signup" className="inline-flex items-center gap-2 bg-white text-gray-900 px-8 py-4 rounded-lg text-lg font-medium hover:bg-gray-100 transition">
            Get Started Free <ArrowRight className="w-5 h-5" />
          </Link>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg font-bold text-white">AI Twin Sync</span>
            </div>
            ...
            <p className="text-gray-500 text-sm">© 2024 AI Twin Sync. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
